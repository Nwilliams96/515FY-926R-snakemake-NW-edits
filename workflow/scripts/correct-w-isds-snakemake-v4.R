...
#Import Data local
bp_asvs <- read_delim(snakemake@input[[2]], delim = "\n", col_names = FALSE)
dr_asvs <- read_delim(snakemake@input[[3]], delim = "\n", col_names = FALSE)
tt_asvs <- read_delim(snakemake@input[[4]], delim = "\n", col_names = FALSE)
...
write_isd_table(asv_table_TT_RR, "asv_table_TT_RR")
write_isd_table(asv_table_BP_RR, "asv_table_BP_RR")
write_isd_table(asv_table_DR_RR, "asv_table_DR_RR")
write_isd_table(asv_table_mean_RR, "asv_table_mean_RR")
write_isd_table(asv_table_median_RR, "asv_table_median_RR")
write_isd_table(asv_table_mean_BP_DR_RR, "asv_table_mean_BP_DR_RR")
write_isd_table(asv_table_mean_BP_TT_RR, "asv_table_mean_BP_TT_RR")
write_isd_table(asv_table_mean_DR_TT_RR, "asv_table_mean_DR_TT_RR")
