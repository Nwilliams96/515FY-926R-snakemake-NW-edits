...
denoisingStatsDF = pd.read_csv(snakemake.input["prokstats"], sep='\t', header=0)
...
#export as tsv
mergedDF.to_csv(snakemake.output[0], encoding="utf-8", sep="\t",index=True, index_label="sample-id")
